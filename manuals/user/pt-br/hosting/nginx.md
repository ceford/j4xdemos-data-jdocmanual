...
Para Ubuntu, execute `aptitude install nginx`. Para outras
distribuições, execute o gerenciador de pacote correspondente, or ver
no ://wiki.nginx.org/Install.

## Instalar PHP FastCGI

Para Ubuntu, leia esse excelente página de como
<a href="http://wiki.nginx.org/PHPFcgiExample" class="external text"
target="_blank" rel="nofollow noreferrer noopener">configurar PHP e
