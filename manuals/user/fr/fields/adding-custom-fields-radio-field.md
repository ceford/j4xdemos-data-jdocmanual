<!-- Filename: J3.x:Adding_custom_fields/Radio_Field / Display title: Ajout de champs personnalisés/Champ Radio -->
...
Radio](https://docs.joomla.org/Radio_form_field_type "Special:MyLanguage/Radio form field type").
