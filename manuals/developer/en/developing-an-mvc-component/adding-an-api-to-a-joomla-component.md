...
This page is intended to document how to integrate the Web Services layer introduced in {{jver|4.0}} into an existing Joomla component. This assumes that you are using the default Joomla MVC layer.
...
<img alt="" src="/images/e/ec/Struct1.png" decoding="async" class="thumbimage" data-file-width="414" data-file-height="262" width="414" height="262">
...
4. Create the manifest file,  ***weblinks.xml***
...
5. Create language files with content
...
Working with it is similar to [Banners Categories](https://docs.joomla.org/Special:MyLanguage/J4.x:Joomla_Core_APIs#Categories)

### Fields 

Route Fields Web Links is: ''v1/fields/weblinks''

Working with it is similar to [Fields Contact](https://docs.joomla.org/Special:MyLanguage/J4.x:Joomla_Core_APIs#Fields_Contact)

### Groups Fields 

Route Groups Fields Web Links is: ''v1/fields/groups/weblinks''

Working with it is similar to [Groups Fields Contact](https://docs.joomla.org/Special:MyLanguage/J4.x:Joomla_Core_APIs#Groups_Fields_Contact)
