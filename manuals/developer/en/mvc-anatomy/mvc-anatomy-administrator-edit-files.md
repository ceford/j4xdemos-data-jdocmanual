...
<!-- -->
             ...
             'details')); ?>
                            ...
                            form->renderField('iso_2'); ?>
                            form->renderField('iso_3'); ?>
                            form->renderField('country_code'); ?>
                            form->renderField('region_code'); ?>
                            form->renderField('subregion_code'); ?>
                            form->renderField('phone_prefix'); ?>
                            form->renderField('currency_code'); ?>
                            form->renderField('id'); ?>
